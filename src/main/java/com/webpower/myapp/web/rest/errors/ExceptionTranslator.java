package com.webpower.myapp.web.rest.errors;
 ...
 * (<a href="https://tools.ietf.org/html/rfc7807"></a>).
 */
@ControllerAdvice
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.webpower.myapp");
    }
    ...
    public ResultResponse<?> handleDataAccessException(DataAccessException ex, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        log.error("请求地址'{}',发生数据库访问异常.", requestURI, ex);
        return ResultResponse.newFailedInstance().code(HttpStatus.SERVICE_UNAVAILABLE).message(ex.getMessage());
    }
    ...
    public ResultResponse<?> handleRuntimeException(RuntimeException e, HttpServletRequest request) {
        ...
        return ResultResponse.newFailedInstance().code(HttpStatus.INTERNAL_SERVER_ERROR).message(e.getMessage());
    }
